                ...
                <div className="gap-4 text-zinc-500 max-w-[90%] ml-[5%]">
                    <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-zinc-300 hover:bg-zinc-100">
                        <div className="px-6 py-4">
                            ...
                            <p className='text-slate-700 text-base '>For more info and purchase send me a message on my Telegram or Whatsapp!</p>
                            <div className="pt-3 max-w-[60%] md:max-w-[65%]">
                                <Link href='https://wa.me/+989965780879' className='flex justify-between'>
                                    ...
                                    <div>
                                        <p className='text-slate-700 text-sm hover:text-green-600 '>Click To Message</p>
                                    </div>
                                </Link>
                                ...
                                <Link href='https://t.me/ashkangl' className='flex justify-between pt-2'>
                                    ...
                                    <div>
                                        <p className=' text-slate-700 text-sm hover:text-sky-400'>Click To Message</p>
                                    </div>
                                </Link>
                            </div>
                        </div>
